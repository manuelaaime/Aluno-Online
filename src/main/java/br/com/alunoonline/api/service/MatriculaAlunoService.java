...
public class MatriculaAlunoService {
    ...
    public HistoricoAlunoResponseDTO emitirHistorico(Long alunoId) {
        ...
        if (matriculaAlunos.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND,
                    "Esse aluno não está matriculado");
        }
        ...
        List<DisciplinasAlunoResponseDTO> disciplinasAluno = matriculaAlunos.stream()
                .map(this::mapearDisciplinasAlunoResponseDTO)
                .toList();

        historicoAluno.setDisciplinasAluno(disciplinasAluno);
    ...
    private MatriculaAluno buscarMatriculaOuLancarExcecao(Long matriculaAlunoId){
        return matriculaAlunoRepository.findById(matriculaAlunoId)
                .orElseThrow(() -> new ResponseStatusException
                        (HttpStatus.NOT_FOUND, "Matrícula do Aluno não encontrada"));
    }
    ...
    private DisciplinasAlunoResponseDTO mapearDisciplinasAlunoResponseDTO(MatriculaAluno matriculaAluno){
